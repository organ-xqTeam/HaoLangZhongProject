...
/**
 * sys_doctor_register_orderEntity
 * @author 范耘诚
 * @version 2019-06-28
 */
@Table(name="sys_doctor_register_order", alias="a", columns={
		...
		@Column(name="doctor_user_id", attrName="doctorUserId", label="医生id(医生中的用户表的id)"),
	}, orderBy="a.update_date DESC"
)
public class DoctorRegisterOrder extends DataEntity<DoctorRegisterOrder> {
	...
	private String doctorUserId;		// 是否删除
	
	public DoctorRegisterOrder() {
		this(null);
	}

	public DoctorRegisterOrder(String id){
		super(id);
	}
